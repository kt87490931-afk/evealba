...
<div class="tbl_head01 tbl_wrap">
  <p style="padding:20px;color:#c00;">g5_jobs_thumb_option_paid 테이블이 없습니다. 프로젝트 루트에서 <code>php run_migration.php</code> 또는 <code>php scripts/run_migration_012.php</code>를 실행해 주세요.</p>
</div>
<?php } else {
