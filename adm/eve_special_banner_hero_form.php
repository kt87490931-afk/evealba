    ...
    <div class="hero-editor-body">
      ...
      <div class="ctrl-grid">
        ...
        <div class="ctrl-row">
          ...
          <input type="text" class="ctrl-input" id="tg-title" maxlength="64" placeholder="예) 강남 룸 80개 1등 대일팀! (30자, 이모지 가능)" value="<?php echo htmlspecialchars($thumb_title, ENT_QUOTES); ?>" oninput="enforceMaxChar(this,30);updatePreview()">
        ...
        <div class="ctrl-row">
          ...
          <input type="text" class="ctrl-input" id="tg-text" maxlength="128" placeholder="예) 🔥 하이퍼블릭 밀빵OK · 5인1조 픽업OK!! (60자, 이모지 가능)" value="<?php echo htmlspecialchars($thumb_text, ENT_QUOTES); ?>" oninput="enforceMaxChar(this,60);updatePreview()">
        ...
        <div class="ctrl-row">
          ...
          <input type="text" class="ctrl-input" id="tg-text2" maxlength="128" placeholder="예) 시급 15,000원 · 초보환영 · 당일지급 (60자, 이모지 가능)" value="<?php echo htmlspecialchars($thumb_text2, ENT_QUOTES); ?>" oninput="enforceMaxChar(this,60);updatePreview()">
...
function enforceMaxChar(el, max){
