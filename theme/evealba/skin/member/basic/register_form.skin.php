...
<style id="ev-referral-modal-styles">#evReferralModal .ev-referral-modal-box{background:#fff;border-radius:14px;max-width:460px;width:100%;max-height:85vh;overflow:hidden;box-shadow:0 20px 60px rgba(0,0,0,.25);display:flex;flex-direction:column;}#evReferralModal .ev-referral-modal-head{background:linear-gradient(135deg,#2D0020,#FF1B6B);padding:16px 20px;display:flex;align-items:center;gap:10px;}#evReferralModal .ev-referral-modal-head-title{color:#fff;font-size:15px;font-weight:800;flex:1;}#evReferralModal .ev-referral-modal-close{width:28px;height:28px;background:rgba(255,255,255,.25);border:none;border-radius:50%;color:#fff;font-size:16px;cursor:pointer;}#evReferralModal .ev-referral-modal-body{padding:20px;overflow-y:auto;flex:1;min-height:80px;}#evReferralModal .ev-referral-summary{margin:0 0 14px;font-size:14px;font-weight:700;color:#333;}#evReferralModal .ev-referral-empty{padding:32px 16px;text-align:center;color:#999;font-size:14px;}#evReferralModal .ev-referral-modal-foot{padding:14px 20px;background:#fff8fb;border-top:1px solid #FFD6E7;text-align:right;}#evReferralModal .ev-referral-modal-ok{padding:10px 24px;background:linear-gradient(135deg,#FF6B35,#FF1B6B);color:#fff;border:none;border-radius:24px;font-size:14px;font-weight:700;cursor:pointer;}#evReferralModal .ev-referral-modal-ok:hover{opacity:.92;}</style>
