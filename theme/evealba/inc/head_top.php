...
<nav>
  <div class="nav-scroll">
    ...
    <a href="<?php echo (defined('G5_URL') && G5_URL) ? rtrim(G5_URL,'/').'/jobs_thumb_shop.php' : '/jobs_thumb_shop.php'; ?>" class="nav-item<?php echo ($nav_active==='thumb_shop') ? ' active' : ''; ?>"><span class="nav-icon">🛒</span>썸네일상점</a>
...
<?php } ?>
      ...
      <div class="msm-section">
        ...
        <a href="<?php echo $_jobs_base; ?>/jobs_thumb_shop.php" class="msm-link">🛒 썸네일상점</a>
