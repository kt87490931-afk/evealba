...
<?php if ($is_member) { ?>
  ...
  <a href="<?php echo G5_BBS_URL; ?>/logout.php" class="btn-login-full" style="display:block;text-align:center;line-height:1.2;">로그아웃</a>
<?php } else { ?>
  <a href="<?php echo G5_BBS_URL; ?>/login.php" class="btn-login-full" style="display:block;text-align:center;line-height:1.2;">로그인</a>
