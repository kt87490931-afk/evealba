...
$_nav_items = array(
    ...
    array('key' => 'notify', 'icon' => '🔔', 'label' => '알림 & 채팅', 'href' => $_nav_base . '/memo_full.php', 'match' => array('memo')),
...
<div class="sidebar-logo-renewal">
  <a href="<?php echo G5_URL; ?>"><em>eve</em>·알바</a>
</div>
...
<?php if ($is_member) { ?>
  <div class="sidebar-user-renewal">
    ...
    <a href="<?php echo G5_BBS_URL; ?>/logout.php" style="font-size:12px;color:#888;">로그아웃</a>
  </div>
<?php } else { ?>
  <a href="<?php echo G5_BBS_URL; ?>/login.php" class="btn-login">로그인</a>
  <a href="<?php echo $_nav_base; ?>/eve_register.php" class="btn-join">회원이 아니신가요? 가입하기</a>
<?php } ?>
</div>
