...
?>
    ...
    <div class="bottom-search">
      <select class="filter-select"><option>–1차 직종선택–</option><option>룸싸롱</option><option>노래주점</option><option>마사지</option><option>기타</option></select>
      <select class="filter-select"><option>–2차 직종선택–</option><option>아가씨</option><option>초미씨</option><option>미씨</option><option>TC</option></select>
      <select class="filter-select"><option>지역선택</option><option>서울</option><option>경기</option><option>인천</option><option>부산</option><option>대구</option></select>
