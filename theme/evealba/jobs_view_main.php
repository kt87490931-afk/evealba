  ...
  <div class="thumb-body">
    <div class="thumb-controls">
      ...
      $gradients = array(
        ...
        14 => 'linear-gradient(135deg,rgb(168,237,234),rgb(254,214,227))',
        15 => 'linear-gradient(135deg,rgb(255,175,189),rgb(255,195,160))',
        16 => 'linear-gradient(135deg,rgb(255,0,110),rgb(131,56,236))',
        17 => 'linear-gradient(135deg,rgb(67,206,162),rgb(24,90,157))',
        18 => 'linear-gradient(135deg,rgb(244,107,69),rgb(238,168,73))',
        19 => 'linear-gradient(135deg,rgb(255,153,102),rgb(255,94,98))',
        20 => 'linear-gradient(135deg,rgb(255,95,109),rgb(255,195,113))',
      );
