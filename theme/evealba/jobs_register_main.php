...
function checkPayment() {
  ...
  data['employ-type'] = emp ? emp.value : '';
  ...
  var am = [];
  document.querySelectorAll('#am-0,#am-1,#am-2,#am-3,#am-4,#am-5,#am-6,#am-7,#am-8,#am-9,#am-10,#am-11,#am-12,#am-13,#am-14,#am-15,#am-16,#am-17,#am-18,#am-19,#am-20,#am-21').forEach(function(c){ if(c.checked){ var l=c.nextElementSibling; if(l) am.push(l.textContent.trim()); } });
  data['amenity'] = am;
  var kw = [];
  document.querySelectorAll('[id^="kw-"]').forEach(function(c){ if(c.checked){ var l=c.nextElementSibling; if(l) kw.push(l.textContent.trim()); } });
  data['keyword'] = kw;
  var mbtiArr = [];
  document.querySelectorAll('input[name="mbti_prefer[]"]:checked').forEach(function(c){ mbtiArr.push(c.value); });
  data['mbti_prefer'] = mbtiArr;
  var total = 0;
  var adPeriod = 30;
  var adLabels = [];
