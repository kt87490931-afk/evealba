...
<div class="mobile-quick-menu">
  ...
  <a href="<?php echo G5_BBS_URL; ?>/memo_form.php" class="mqm-btn mqm-memo"><span class="mqm-icon">📩</span><span class="mqm-label">쪽지<?php if ($_qm_memo_badge > 0) { ?> <span class="ql-memo-badge">+<?php echo $_qm_memo_badge; ?></span><?php } ?></span></a>
</div>
